...
//  compared to main7: add utility by wealth
...
const double rhopar_consumption = 1.5;
const double rhopar_wealth = 4.0;
...
// const double risk_trans[7][7] = {
// {0.0062097327, 0.0605978868, 0.2417309739, 0.3829249254, 0.2417296387, 0.0605972149, 0.0062096275},
// {0.0062097152, 0.0605977748, 0.2417307514, 0.3829249254, 0.2417298612, 0.0605973269, 0.0062096451},
// {0.0062096976, 0.0605976629, 0.2417305288, 0.3829249254, 0.2417300838, 0.0605974389, 0.0062096626},
// {0.0062096801, 0.0605975509, 0.2417303063, 0.3829249254, 0.2417303063, 0.0605975509, 0.0062096801},
// {0.0062096626, 0.0605974389, 0.2417300838, 0.3829249254, 0.2417305288, 0.0605976629, 0.0062096976},
// {0.0062096451, 0.0605973269, 0.2417298612, 0.3829249254, 0.2417307514, 0.0605977748, 0.0062097152},
// {0.0062096275, 0.0605972149, 0.2417296387, 0.3829249254, 0.2417309739, 0.0605978868, 0.0062097327}};

// //  p_e=0.000001, std_e = 0.03
// const double risk_states[7] ={-0.09000000, -0.06000000, -0.03000000, 0.00000000, 0.03000000, 0.06000000, 0.09000000};
// const double risk_trans[7][7] = {
// {0.0062097327, 0.0605978868, 0.2417309739, 0.3829249254, 0.2417296387, 0.0605972149, 0.0062096275},
// {0.0062097152, 0.0605977748, 0.2417307514, 0.3829249254, 0.2417298612, 0.0605973269, 0.0062096451},
// {0.0062096976, 0.0605976629, 0.2417305288, 0.3829249254, 0.2417300838, 0.0605974389, 0.0062096626},
...
// //  p_e=0.000001, std_e = 0.02
// const double risk_states[7] = {-0.06000000, -0.04000000, -0.02000000, -0.00000000, 0.02000000, 0.04000000, 0.06000000};
// const double risk_trans[7][7] = {
//     {0.0062097327, 0.0605978868, 0.2417309739, 0.3829249254, 0.2417296387, 0.0605972149, 0.0062096275},
//     {0.0062097152, 0.0605977748, 0.2417307514, 0.3829249254, 0.2417298612, 0.0605973269, 0.0062096451},
//     {0.0062096976, 0.0605976629, 0.2417305288, 0.3829249254, 0.2417300838, 0.0605974389, 0.0062096626},
...
// //  p_e=0.000001, std_e = 0.015
// const double risk_states[7] = {-0.04500000, -0.03000000, -0.01500000, 0.00000000, 0.01500000, 0.03000000, 0.04500000};
// const double risk_trans[7][7] = {
//     {0.0062097327, 0.0605978868, 0.2417309739, 0.3829249254, 0.2417296387, 0.0605972149, 0.0062096275},
//     {0.0062097152, 0.0605977748, 0.2417307514, 0.3829249254, 0.2417298612, 0.0605973269, 0.0062096451},
//     {0.0062096976, 0.0605976629, 0.2417305288, 0.3829249254, 0.2417300838, 0.0605974389, 0.0062096626},
...
// Utility
#define MUc(x) (pow((x), -rhopar_consumption))
#define inv_MU(u) (pow((u), (-(1.0 / rhopar_consumption))))
#define U(x) (pow((x), (1.0 - rhopar_consumption)) / (1.0 - rhopar_consumption))
#define U_W(x) (pow((x), (1.0 - rhopar_wealth)) / (1.0 - rhopar_wealth))
            ...
            for (risk_index = 0; risk_index < size_risk; risk_index++)
            {
                ...
                for (laborincome_index = 0; laborincome_index < size_laborincome; laborincome_index++)
                {
                    ...
                    for (portfoliochoice_index = 0; portfoliochoice_index < size_portfoliochoice + 1; portfoliochoice_index++)
                    {
                        ...
                        // consendo[index_ARLP(asset_index, risk_index, laborincome_index, portfoliochoice_index)]=inv_MU(betapar * dtempnext);
                        VFendo[index_ARLP(asset_index, risk_index, laborincome_index, portfoliochoice_index)] = U(cohendo[index_ARLP(asset_index, risk_index, laborincome_index, portfoliochoice_index)] - K[asset_index]) + U_W(K[asset_index]) + betapar * tempnext;
                    }
                }
                ...
                for (laborincome_index = 0; laborincome_index < size_laborincome; laborincome_index++)
                {
                    ...
                    for (asset_index = 0; asset_index < size_asset; asset_index++)
                    {
                        ...
                        if (cohexo < cohendo[index_ARLP(0, risk_index, laborincome_index, portfoliochoice_index)])
                        {
                            ...
                            VF[index_ARLP(asset_index, risk_index, laborincome_index, portfoliochoice_index)] = U(cohexo - save[index_ARLP(asset_index, risk_index, laborincome_index, portfoliochoice_index)]) + U_W(save[index_ARLP(asset_index, risk_index, laborincome_index, portfoliochoice_index)]) + (VFendo[index_ARLP(0, risk_index, laborincome_index, portfoliochoice_index)] - U((cohendo[index_ARLP(0, risk_index, laborincome_index, portfoliochoice_index)] - K[0])));
                        }
...
int main()
{
    ...
    std::string filename_dist = "csv\\dist10,pe=e-6,std=0.01,premium=" + std::to_string(premium) + ",wage=" + std::to_string(wagerate) + ",rf=" + std::to_string(r_f) + ",Psize=" + std::to_string(size_portfoliochoice) + ",rho_c=" + std::to_string(rhopar_consumption) + ",rho_w=" + std::to_string(rhopar_wealth) + ".csv ";
    std::string filename_policy = "csv\\policy10,pe=e-6,std=0.01,premium=" + std::to_string(premium) + ",wage=" + std::to_string(wagerate) + ",rf=" + std::to_string(r_f) + ",Psize=" + std::to_string(size_portfoliochoice) + ",rho_c=" + std::to_string(rhopar_consumption) + ",rho_w=" + std::to_string(rhopar_wealth) + ".csv ";
    std::string filename_VF = "csv\\VF10,pe=e-6,std=0.01,premium=" + std::to_string(premium) + ",wage=" + std::to_string(wagerate) + ",rf=" + std::to_string(r_f) + ",Psize=" + std::to_string(size_portfoliochoice) + ",rho_c=" + std::to_string(rhopar_consumption) + ",rho_w=" + std::to_string(rhopar_wealth) + ".csv ";
    std::string filename_Port = "csv\\Portfolio10,pe=e-6,std=0.01,premium=" + std::to_string(premium) + ",wage=" + std::to_string(wagerate) + ",rf=" + std::to_string(r_f) + ",Psize=" + std::to_string(size_portfoliochoice) + ",rho_c=" + std::to_string(rhopar_consumption) + ",rho_w=" + std::to_string(rhopar_wealth) + ".csv ";
