...
int main()
{
    ...
    std::string filename_dist = "csv\\dist,premium=" + std::to_string(premium) + ",wage=" + std::to_string(wagerate) + ",rf=" + std::to_string(r_f) + ".csv ";
    std::string filename_policy = "csv\\policy,premium=" + std::to_string(premium) + ",wage=" + std::to_string(wagerate) + ",rf=" + std::to_string(r_f) + ".csv ";
    std::string filename_VF = "csv\\VF,premium=" + std::to_string(premium) + ",wage=" + std::to_string(wagerate) + ",rf=" + std::to_string(r_f) + ".csv ";
    std::string filename_Port = "csv\\Portfolio,premium=" + std::to_string(premium) + ",wage=" + std::to_string(wagerate) + ",rf=" + std::to_string(r_f) + ".csv ";
